...
while answer1.lower() == 'y' :
    ...
    if ch == 1 :
        ...
        filehan.write("Sr.No." + "   Name of Medicine" + "       Manufacturer" + "            Batch No." + "              Manu. Date" + "   Exp Date" + "   Quantity" + "   Price" + "   Amount" + "\n")
        ...
        for i in range(n):
            ...
            for row in result:
                if cursor.rowcount == 0 :   # Checking the existence of a medicine
                    ...
                    text = (str(i+1) + "         " + nmed + "          " + str(nmanu) + "          " + str(batchn) + "               " + str(mandate) + "    " + str(expdate) + "    " + str(quan) + "      " + str(price) + "    " + str(amt))
                print()
